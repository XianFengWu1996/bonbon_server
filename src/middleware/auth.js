...
var auth = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var token, verified, userResult, error_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                if (!token) {
                    return [2 /*return*/, res.status(401).send({ error: "Not authorized" })];
                }
                verified = jsonwebtoken_1.default.verify(token, process.env.JWT_SECRET);
                return [4 /*yield*/, User_1.default.findOne({ _id: verified._id, 'tokens.token': token })];
            case 1:
                userResult = _b.sent();
                if (!userResult) {
...
var admin = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var token, verified, userResult, error_2;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
            ...
            case 1:
                ...
                if (userResult.role !== User_1.Role.admin) {
                    return [2 /*return*/, res.status(401).send({ error: "Not authorized" })];
                }
                // save the user id and token to the req object
                req.user = userResult;
            ...
            case 2:
                error_2 = _b.sent();
                return [2 /*return*/, res.status(400).send({ error: error_2.message })];
            case 3: return [2 /*return*/];
        }
    });
}); };
